  ...
  return (
    <div className="bg-white text-gray-800 font-sans">
      ...
      >
        ...
        <p className="text-center max-w-4xl mx-auto leading-relaxed mb-10">
      ...
      <motion.section
        ...
        transition={{ duration: 0.6 }}
        viewport={{ once: true }}
        className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-6"
      >
        <div className="bg-white shadow rounded-xl p-8 transform transition hover:scale-105 hover:shadow-xl">
        ...
        <div className="bg-white shadow rounded-xl p-8 transform transition hover:scale-105 hover:shadow-xl">
          <h3 className="text-2xl font-bold text-sky-600 mb-3">Our Mission</h3>
          <p className="leading-relaxed">
